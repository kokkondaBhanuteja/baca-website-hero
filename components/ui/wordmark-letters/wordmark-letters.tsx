...
export function WordmarkLetters({
  ...
  useEffect(() => {
    ...
    // images / videos are typically declared at module scope by the caller, so
    // re-running on identity change is fine and avoids stale-closure bugs if
    // the caller swaps assets later.
  }, [text, useVideo, images, videos])
