    ...
    <section className="relative flex min-h-[100svh] w-full flex-col justify-end overflow-hidden bg-paper">
      <HeroEntry>
        <div className="relative flex w-full flex-col justify-end pb-12 pt-28 sm:pb-16">
          <div
            data-hero-reveal
            className="mx-auto mb-6 w-full max-w-content px-5 sm:px-8"
          >
          ...
          <div className="mx-auto grid w-full max-w-content grid-cols-1 items-end gap-10 px-5 sm:px-8 lg:grid-cols-12">
